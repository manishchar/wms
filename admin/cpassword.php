                    ...
                    <div class="alert-inner">
                        ...
                        <div class="alert-list">
                            <div class="alert alert-success alert-dismissible" role="alert">
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true"><i class="notika-icon notika-close"></i></span></button> Well done! <?php // echo $_SESSION['successmsg'];  ?> <a href="" class="alert-link">this important alert message.</a>
                            </div>
                       ...
                       <!--  <div class="form-example-int form-horizental">
                        ...
                        <div class="form-example-int form-horizental mg-t-15">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                        <div class="nk-int-st">
                                            <input type="text" name="currentPassword" class="form-control input-sm" placeholder="Current Password">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-example-int mg-t-15">
                            <div class="row">
                                ...
                                <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                    <button type="button" name="changePassword" class="btn btn-success notika-btn-success">Change Password</button>
                                </div>
                            </div>
                        </div>
                        </form>
