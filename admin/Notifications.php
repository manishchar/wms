            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        ...
                        <li class="active"><a data-toggle="" href="Notifications.html"><i class="notika-icon notika-mail"></i> Notifications</a>
                        </li>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="dialog-inner sm-res-mg-t-30">
                        <div class="contact-hd dialog-hd">
                            ...
                            <p style="color:red">Dated: 17 January 2018 Published By Bhopal Incinerators Ltd.</p>
                        </div>
                        <div class="dialog-pro dialog">
                            <button class="btn btn-info" id="sa-title">Read Full Notification</button>
                        </div>
                    </div>
                </div>
            </div>
